            ...
            <TabsList className="p-0 bg-background justify-start rounded-none h-12">
              {tabs.map((tab, index) => (
                <TabsTrigger
                  key={index}
                  value={tab.value}
                  className="text-muted-foreground rounded-none bg-background data-[state=active]:shadow-none border-b-2 border-transparent data-[state=active]:border-b-primary data-[state=active]:text-accent-foreground h-full hover:text-accent-foreground cursor-pointer"
                >
                  <tab.icon />
                  {tab.label}
                </TabsTrigger>
